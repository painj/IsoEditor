...
set shortmess=aoO
badd +45 src/IsoWS/IsoEditor/main.cpp
badd +1 src/IsoWS/IsoEditor/editor.h
badd +6 .vimrc
argglobal
silent! argdel *
edit src/IsoWS/IsoEditor/main.cpp
...
45
normal! 0
lcd ~/src/IsoWS/IsoEditor
wincmd w
argglobal
edit ~/src/IsoWS/IsoEditor/editor.h
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 35 - ((11 * winheight(0) + 7) / 14)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
35
